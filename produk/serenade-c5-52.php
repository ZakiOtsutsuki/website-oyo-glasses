...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    $_SESSION['gambar'] = 'src/img/serenade-c5-52-1.png';
        ...
        <div class="detail-produk-gambar">
            ...
            <div class="image-row">
                <div class="image-column">
                  <img src="../src/img/serenade-c5-52-1.png" alt="kacamata" onclick="showImage(this.src);" id="gambar-default">
                </div>
                <div class="image-column">
                  <img src="../src/img/serenade-c5-52-2.png" alt="kacamata" onclick="showImage(this.src);">
                </div>
                <div class="image-column">
                  <img src="../src/img/serenade-c5-52-3.png" alt="kacamata" onclick="showImage(this.src);">
                </div>
                <div class="image-column">
                  <img src="../src/img/serenade-c5-52-4.png" alt="kacamata" onclick="showImage(this.src);">
                </div>
              </div>
        </div>
