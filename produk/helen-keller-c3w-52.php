...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    $_SESSION['gambar'] = 'src/img/helen-keller-c3w-52-1.png';
...
<body>
    ...
    <div class="detail-produk-container">
        <div class="detail-produk-gambar">
            ...
            <div class="image-row">
                <div class="image-column">
                  <img src="../src/img/helen-keller-c3w-52-1.png" alt="kacamata" onclick="showImage(this.src);" id="gambar-default">
                </div>
                <div class="image-column">
                  <img src="../src/img/helen-keller-c3w-52-2.png" alt="kacamata" onclick="showImage(this.src);">
                </div>
                <div class="image-column">
                  <img src="../src/img/helen-keller-c3w-52-3.png" alt="kacamata" onclick="showImage(this.src);">
                </div>
                <div class="image-column">
                  <img src="../src/img/helen-keller-c3w-52-4.png" alt="kacamata" onclick="showImage(this.src);">
                </div>
              </div>
        </div>
        <div class="detail-produk-deskripsi">
            ...
            <p id="harga">Harga</p>
            <p id="harga-produk">Rp. 340.000</p>
