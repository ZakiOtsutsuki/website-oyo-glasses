...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    $_SESSION['gambar'] = 'src/img/ilustro-c7-53-1.png';
...
<body>
    ...
    <div class="detail-produk-container">
        <div class="detail-produk-gambar">
            ...
            <div class="image-row">
                <div class="image-column">
                  <img src="../src/img/ilustro-c7-53-1.png" alt="kacamata" onclick="showImage(this.src);" id="gambar-default">
                </div>
                <div class="image-column">
                  <img src="../src/img/ilustro-c7-53-2.png" alt="kacamata" onclick="showImage(this.src);">
                </div>
                <div class="image-column">
                  <img src="../src/img/ilustro-c7-53-3.png" alt="kacamata" onclick="showImage(this.src);">
                </div>
                <div class="image-column">
                  <img src="../src/img/ilustro-c7-53-4.png" alt="kacamata" onclick="showImage(this.src);">
                </div>
              </div>
        </div>
        <div class="detail-produk-deskripsi">
            <h1>Ilustro C7 53</h1>
            <p id="harga">Harga</p>
            <p id="harga-produk">Rp. 510.000</p>
