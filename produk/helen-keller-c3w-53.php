...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    $_SESSION['gambar'] = 'src/img/helen-keller-c3w-53-1.png';
        ...
        <div class="detail-produk-gambar">
            ...
            <div class="image-row">
                <div class="image-column">
                  <img src="../src/img/helen-keller-c3w-53-1.png" alt="kacamata" onclick="showImage(this.src);" id="gambar-default">
                </div>
                <div class="image-column">
                  <img src="../src/img/helen-keller-c3w-53-2.png" alt="kacamata" onclick="showImage(this.src);">
                </div>
                <div class="image-column">
                  <img src="../src/img/helen-keller-c3w-53-3.png" alt="kacamata" onclick="showImage(this.src);">
                </div>
                <div class="image-column">
                  <img src="../src/img/helen-keller-c3w-53-4.png" alt="kacamata" onclick="showImage(this.src);">
                </div>
              </div>
        </div>
